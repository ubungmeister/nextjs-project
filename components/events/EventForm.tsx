import {FormEventHandler, useRef, KeyboardEvent, useState} from 'react';
...
function NewMeetupForm({addNewEvent}:AddPostObjType) {
    ...
    return (
        <div className="flex flex-col items-center pt-10 ">
            <form className="bg-white shadow-md rounded pl-24 pr-24 pt-5 pb-5">
                ...
                <div className=" mb-4">
                    ...
                    <div onClick={()=>onSubmitHandler()} className='px-10 py-2 w-28 font-bold ml-24 text-white bg-blue-300 rounded-full hover:bg-red-500 cursor-pointer'>Post</div>
